...
'''This section represents the active pool that keeps on tracking the prices 
of the actively monitored tokens. The prices are tracked on to a time series database'''

class ActiveTracking(BaseModel):
    tokens : deque
    token_ids : deque
